...
export const useDeletePlayerPenalty = () => {
    ...
    return useMutation({
        mutationFn: (player_uuid: string) => deletePlayerPenalty(player_uuid),

        onSuccess: () => { console.log("Successfully deleted player penalty.") },
...
export const useDeletePenalty = () => {
    ...
    return useMutation({
        ...
        onSuccess: () => { console.log("Successfully deleted penalty.") },
