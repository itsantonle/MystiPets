...
router
  .route("/updatePenaltyDuration/:penalty_id")
  .put(updatePenaltyDuration)
router
  .route("/updatePenaltyDescription/:penalty_id")
  .put(updatePenaltyDescription)
router
  .route("/deletePlayerPenalty/:player_uuid")
  .delete(deletePlayerPenalty)
