    ...
    return (
        <div className = "panel-container position-absolute top-80 start-50 translate-middle">
            <div className = "counter-container">
                <div className = "counter-style"> <img src={happyStar} className="img-fluid" />: {happinessValue} </div>
                <div className = "counter-style"> <img src={meat} className="img-fluid" />: {hungerValue} </div>
            </div>
            ...
            <div className="name-bar-button-container">
                <div className="name-buttons-container">
                    ...
                    <button className = "button-style" type = "button" onClick={manageHappiness}><img src={feedButton} className="img-fluid"/></button>
                    <button className = "button-style" type = "button" onClick={manageHappiness}><img src={playButton} className="img-fluid"/></button>
                    <button className = "button-style" type = "button" onClick={manageHappiness}><img src={playButton} className="img-fluid"/></button>
                </div>
