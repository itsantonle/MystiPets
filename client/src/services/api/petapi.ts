...
export const getUserPet = async (player_uuid: string): Promise<Pet[]> => {
...
export const updatePetHealth = async (player_uuid: string, health: number) => {
  await petAPI.put(`/updateHealth/${player_uuid}`, { health })
}

export const updatePetName = async (player_uuid: string, pet_name: string) => {
  await petAPI.put(`/updateName/${player_uuid}`, { pet_name })
}

export const updatePetHunger = async (player_uuid: string, hunger_status: number) => {
  await petAPI.put(`/updateHunger/${player_uuid}`, { hunger_status })
}

export const updatePetHappiness = async (player_uuid: string, happiness_status: number) => {
  await petAPI.put(`/updateHappiness/${player_uuid}`, { happiness_status })
}

export const updatePetDeath = async (player_uuid: string, is_dead: boolean) => {
  await petAPI.put(`/updateDeath/${player_uuid}`, { is_dead })
}

export const updatePetLeaving = async (player_uuid: string, has_left: boolean) => {
